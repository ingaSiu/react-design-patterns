...
// few hardcoded users with different roles
      ...
      {showForm && (
        <div className="flex flex-col m-2">
          ...
          >
            ...
            <Form.Field name="email" label="Email Address" type="email" required />
            <Form.Select name="role" label="Role" options={roleOptions} required />
            <Form.Buttons
